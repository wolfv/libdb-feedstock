...
Installing `db` from the `conda-forge` channel can be achieved by adding `conda-forge` to your channels with:
...
Updating db-feedstock
=====================

If you would like to improve the db recipe or build a new
...
Note that all branches in the conda-forge/db-feedstock are
